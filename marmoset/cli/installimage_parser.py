...
def add_to(parser, name, **kwargs):
    ...
    installimage_create = subcommands.add_parser(
        'create',
        help='Create a Installimage config for an MAC Address.',
        aliases=[
            'c',
            'add'])
    installimage_create.add_argument(
        'mac', help='MAC address to create Installimage config for')
    ...
    installimage_remove = subcommands.add_parser(
        'remove', help='remove a installimage config for a MAC address',
        aliases=[
            'r',
            'delete',
            'del',
